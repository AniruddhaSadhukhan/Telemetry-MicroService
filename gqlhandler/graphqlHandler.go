...
import (
	...
	"go-telemetry-server/gqlhandler/mutation"
	"go-telemetry-server/gqlhandler/query"
...
var mutationMap = graphql.Fields{
	mutation.AddTelemetryEventMutation.Name: mutation.AddTelemetryEventMutation,
}
var queryMap = graphql.Fields{
	query.TelemetryEventQuery.Name: query.TelemetryEventQuery,
}
